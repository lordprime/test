                    ...
                    <div className="experience__content">
                        <article className='experience__details'>
                            ...
                            <div>
                                ...
                                <small className='text-light'>Successfully identified and reported a high security vuln in a web application. Performed automated security testing and worked in configuration of security testing with custom scripts.</small>
                            </div>
                        </article>
                    </div>
                </div>
